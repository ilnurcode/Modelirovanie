...
```powershell
consultant.cmd --repo . new demo --prompt "Описание процесса" --product "1С:ERP Управление предприятием 2" --release "2.5" --deliverable consultant
...
```powershell
consultant.cmd --repo . new demo --file "C:\Users\User\Desktop\tz.md" --product "1С:ERP Управление предприятием 2" --release "2.5.27.49" --deliverable consultant
```
